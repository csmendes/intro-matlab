%{
    ...
    the sum of its elements that are in the diagonal and are to the right of it. 
    ...
    the uppertriangular part of the matrix. The name of the output argument is summa.
